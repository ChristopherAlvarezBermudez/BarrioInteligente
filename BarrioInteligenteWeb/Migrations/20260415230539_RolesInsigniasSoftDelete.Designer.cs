...
namespace BarrioInteligenteWeb.Migrations
{
    ...
    [Migration("20260415230539_RolesInsigniasSoftDelete")]
    partial class RolesInsigniasSoftDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BarrioInteligenteWeb.Models.DenunciaUsuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BarrioInteligenteWeb.Models.Usuario", b =>
                {
                    ...
                    b.Property<string>("MotivoReputacion")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("PuntosReputacion")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BarrioInteligenteWeb.Models.DenunciaUsuario", b =>
                {
                    b.HasOne("BarrioInteligenteWeb.Models.Usuario", "Denunciante")
                        .WithMany()
                        .HasForeignKey("DenuncianteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BarrioInteligenteWeb.Models.Usuario", "Reportado")
                        .WithMany()
